VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} cStage1 
   Caption         =   "QuestKeeper"
   ClientHeight    =   8970.001
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   12015
   OleObjectBlob   =   "cStage1.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "cStage1"
...
Private Sub UserForm_Activate() ' Main Game Loop, all code in this sub is executed every PauseTime seconds.
    Do While cStage1.Visible = True And stopMove = False
    ...
    Select Case currentDirection
        Case "Down"
            Call cStage1.MoveDown
        Case "Up"
            Call cStage1.MoveUp
        Case "Left"
            Call cStage1.MoveLeft
        Case "Right"
            Call cStage1.MoveRight
    End Select
    ...
    cStage1.Caption = "John Gokongwei School of Management Student Enterprise Center - Books read: " & pogipoints & "/" & numberOfBooks
    
    Loop
End Sub

Private Sub UserForm_Initialize()
    cStage1.ScrollBars = fmScrollBarsNone
    cStage1.ScrollTop = 0
    cStage1.ScrollLeft = 540
...
Sub MoveUp()
    ...
    Else
        charPlayer.Top = charPlayer.Top - 30
            ...
            cStage1.ScrollTop = charPlayer.Top - 100
...
Sub MoveRight()
    ...
    Else
        charPlayer.Left = charPlayer.Left + 30
            ...
            cStage1.ScrollLeft = charPlayer.Left - 180
