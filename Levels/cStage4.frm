VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} cStage4 
   Caption         =   "QuestKeeper"
   ClientHeight    =   9240.001
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   11865
   OleObjectBlob   =   "cStage4.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "cStage4"
...
Private Sub UserForm_Activate() ' Main Game Loop, all code in this sub is executed every PauseTime seconds.
    Do While cStage4.Visible = True And stopMove = False
    ...
    Select Case currentDirection
        Case "Down"
            Call cStage4.MoveDown
        Case "Up"
            Call cStage4.MoveUp
        Case "Left"
            Call cStage4.MoveLeft
        Case "Right"
            Call cStage4.MoveRight
    End Select
    ...
    cStage4.Caption = "Red Brick Road - Books read: " & pogipoints & "/" & numberOfBooks
    
    Loop
End Sub

Private Sub UserForm_Initialize() ' Sets scroll bar to (0,0)
    cStage4.ScrollBars = fmScrollBarsNone
    cStage4.ScrollTop = 0
    cStage4.ScrollLeft = 0
...
' -----------------------------------------------------
    ...
    For i = 2 To numberOfTrees
        Controls("Tree" & i).Picture = Tree1.Picture
        Controls("Tree" & i).BackStyle = 0
        Controls("Tree" & i).PictureSizeMode = 1
    Next i
...
Sub MoveUp()
    ...
    Else
        ...
        If charPlayer.Top >= 100 Then
            cStage4.ScrollTop = charPlayer.Top - 100
        End If
    End If
End Sub
...
Sub MoveRight()
    ...
    Else
        ...
        If charPlayer.Left >= 100 Then
            cStage4.ScrollLeft = charPlayer.Left - 180
        End If
    End If
End Sub
