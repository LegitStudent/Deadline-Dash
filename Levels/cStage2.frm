VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} cStage2 
   Caption         =   "QuestKeeper"
   ClientHeight    =   8970.001
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   12015
   OleObjectBlob   =   "cStage2.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "cStage2"
...
Private Sub UserForm_Activate() ' Main Game Loop, all code in this sub is executed every PauseTime seconds.
    Do While cStage2.Visible = True And stopMove = False
    ...
    Select Case currentDirection
        Case "Down"
            Call cStage2.MoveDown
        Case "Up"
            Call cStage2.MoveUp
        Case "Left"
            Call cStage2.MoveLeft
        Case "Right"
            Call cStage2.MoveRight
    End Select
    ...
    cStage2.Caption = "Science Education Complex Walk - Books read: " & pogipoints & "/" & numberOfBooks
    
    Loop
End Sub

Private Sub UserForm_Initialize() ' Sets scroll bar to (0,0)
    cStage2.ScrollBars = fmScrollBarsNone
    cStage2.ScrollTop = 0
    cStage2.ScrollLeft = 0
...
Sub MoveUp()
    ...
    Else
        ...
        If charPlayer.Top >= 100 Then
            cStage2.ScrollTop = charPlayer.Top - 100
        End If
    End If
End Sub
...
Sub MoveRight()
    ...
    Else
        ...
        If charPlayer.Left >= 100 Then
            cStage2.ScrollLeft = charPlayer.Left - 180
        End If
    End If
End Sub
